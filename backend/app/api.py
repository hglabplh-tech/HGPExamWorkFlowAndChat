...
router = APIRouter()
for child in (users_router, trust_router, courses_router, examinations_router, content_router, research_router, submissions_router, chat_router, grading_router):
